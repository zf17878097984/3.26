...
<dl class="leftmenu">
    ...
    <dd>
        ...
        <ul class="menuson">
            ...
            <li><cite></cite><a href="<%=basePath%>jsp/backstage/admin/toUpdateMyAdmin.jsp" target="rightFrame">修改基本信息</a><i></i></li>
        </ul>
    </dd>
    ...
    <dd>
        ...
        <ul class="menuson">
            <li><cite></cite><a href="admin/adminmanage/adminmanage" target="rightFrame">管理员管理</a><i></i></li>
        </ul>
    </dd>
    ...
    <dd>
        <div class="title">
            <span><img src="images/leftico02.png" /></span>订单管理
        </div>
        <ul class="menuson">
